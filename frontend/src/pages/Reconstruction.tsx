...
> = {
  ...
  "interview-result": {
    ...
    story: {
      ...
      paragraphs: [
        "면접 결과를 확인하기로 한 오후. 화면을 열기 직전 심박은 112 bpm까지 올라갔고, 개인 기준선과의 차이는 +2.4σ로 커졌습니다. 큰 움직임이 함께 나타나지 않았다는 점은 이 변화가 단순한 신체 활동만으로 설명되지는 않는다는 단서를 남깁니다.",

        "VIVIA는 이 숫자에 감정의 이름을 바로 붙이지 않습니다. 대신 그때의 몸이 평소와 달랐다는 사실과 그 변화가 결과를 확인하기 직전의 시간 위에 놓여 있었다는 것을 하나의 기억 재료로 연결합니다.",
      ],
