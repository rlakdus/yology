      ...
      <main>
        <section className="vh3-hero">
          ...
          <div className="vh3-hero-grid shell">
            ...
            <div className="vh3-hero-media" data-reveal>
              ...
              <button
                className="vh3-signal-card card-c"
                onClick={() => navigate("/vr/he/event_001")}
              >
        ...
        <section className="vh3-about shell" data-reveal>
          <div className="vh3-section-heading">
            ...
            <div>
              ...
              <p>
                몸이 남긴 신호를 단서로, 지나간 순간을 더 선명하게 바라보고
                삶의 맥락을 다시 연결합니다.
              </p>
              <button
                className="vh3-text-link"
                onClick={() => navigate("/how-it-works")}
              >
            ...
            <div className="vh3-concept-cards">
              {[
                ...
                return (
                  <article
                    key={title as string}
                    className={`vh3-concept-card ${tone}`}
        ...
        <section className="vh3-dark-band" data-reveal>
          <div className="shell vh3-story-band">
            <div className="vh3-dark-copy">
              <span className="vh3-kicker light">
                YOUR STORY, RECONSTRUCTED
              </span>
              <h2>
                당신이 놓친
                <br />
        ...
        <section className="vh3-insight shell" data-reveal>
          <div className="vh3-insight-copy">
            ...
            <button
              ...
              onClick={() => navigate("/event")}
            >
              이벤트 상세 보기 <ArrowRight size={15} />
            </button>
          </div>

          <div className="vh3-insight-grid">
            <article onClick={() => navigate("/event")}>
              <span>신호 변화</span>
              <strong>+18%</strong>
        ...
        <section className="vh3-final-band" data-reveal>
          <div className="shell">
            ...
            <div>
              <button
                className="vh3-btn aqua-button"
                onClick={() => navigate("/moment")}
              >
                지금 시작하기 <ArrowRight size={16} />
              </button>
              <button
                className="vh3-btn dark-ghost"
                onClick={() => navigate("/how-it-works")}
              >
                How it works
              </button>
      ...
      <footer className="vh3-footer">
        <div className="shell">
          ...
          <div>
            ...
            <span onClick={() => navigate("/moment")}>My Moments</span>
            <span onClick={() => navigate("/event")}>Event</span>
            <span onClick={() => navigate("/reconstruction")}>
              Reconstruction
            </span>
          </div>
          ...
          <div>
            ...
            <span onClick={() => navigate("/vr/he/event_001")}>VR Replay</span>
          </div>
