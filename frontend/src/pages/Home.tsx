      ...
      <main>
          ...
          <div className="vh3-hero-grid shell">
            <div className="vh3-hero-copy" data-reveal>
              <span className="vh3-eyebrow">
                VIA SIGNALS, VIVID STORIES, FOR VITA.
              </span>

              <h1 className="vh3-hero-title">
                <span className="vh3-hero-title-dark">몸의 신호를 따라,</span>
                <span className="vh3-hero-title-accent">
                  기억은 다시 선명하게.
                  <span className="vh3-title-underline" aria-hidden="true" />
                </span>
              </h1>

              <p>
                VIVIA는 생체신호의 변화와 일상의 맥락을 연결해
                <br />
                의미 있는 순간을 발견하고, 다시 경험할 수 있는 이야기로
                재구성합니다.
              </p>
            ...
            <div className="vh3-hero-media" data-reveal>
              ...
              >
                ...
                <path
                  d="M0,92 C130,70 190,118 290,92 C390,66 415,48 510,70 C600,91 640,122 760,70"
                  fill="none"
              ...
              <div className="vh3-signal-card card-c is-static">
                <span>REPLAY READY</span>
                <strong>이 순간 다시 보기</strong>
                <Play size={18} />
              </div>
            </div>
          </div>
        ...
        <section className="vh3-about shell" data-reveal>
          <div className="vh3-section-heading">
            <div>
              <span className="vh3-section-label"><b>01</b> ABOUT VIVIA</span>
              <h2>
                <span>VIVIA는 몸의 신호를 읽어</span>
                <span>삶의 순간을 이야기로 전합니다.</span>
              </h2>
              <p>
                <span>몸이 남긴 신호를 단서로, 지나간 순간을</span>
                <span>더 선명하게 바라보고 삶의 맥락을</span>
                <span>다시 연결하는 라이프 케어 플랫폼입니다.</span>
              </p>
            </div>
          </div>

          <div className="vh3-connect-panel vh3-interactive-surface" onMouseMove={moveGlow}>
            <div className="vh3-brand-line">
              <span className="aqua">Via Signals,</span>{" "}
              <span className="lav">Vivid Stories,</span> for{" "}
              <span className="coral">Vita.</span>
            </div>
        ...
        <section className="vh3-concept" data-reveal>
          <div className="shell vh3-concept-inner">
            <div className="vh3-concept-copy">
              <span className="vh3-section-label"><b>02</b> VIVIA CONCEPT</span>
              <h2>
                몸은, 당신이 놓친
                <br />
                순간을 기억합니다.
              ...
              <p>
                우리는 많은 순간을 흘려보냅니다. VIVIA는 몸에 남은 변화와
                주변의 기록을 함께 읽어, 다시 바라볼 수 있는 순간으로
                연결합니다.
              </p>
            </div>
            ...
            <div className="vh3-concept-cards">
              {[
                [
                  "기록되지 않은 순간",
                  "일상의 수많은 장면은 기록되지 않고 지나갑니다.",
                  Waves,
                  "aqua",
                ],
                [
                  "신호로 남은 흔적",
                  "그 순간 몸의 변화는 데이터의 흔적으로 남습니다.",
                  BrainCircuit,
                  "coral",
                ],
                [
                  "기억으로 재탄생",
                  "AI가 신호와 맥락을 연결해 다시 만날 수 있는 이야기로 만듭니다.",
                  Sparkles,
                  "navy",
                ],
                ...
                return (
                  <article
                    key={title as string}
                    className={`vh3-concept-card vh3-interactive-surface ${tone}`}
                    onMouseMove={moveGlow}
                  >
                    <span className="vh3-orb">
                      <IconComp />
                    </span>
        ...
        <section className="vh3-how shell" data-reveal>
          <div className="vh3-inline-head">
            <span className="vh3-section-label"><b>03</b> HOW IT WORKS</span>
            <h2>VIVIA는 이렇게 작동합니다.</h2>
            <button onClick={() => navigate("/how-it-works")}>
              전체 과정 보기 <ArrowRight size={15} />
            </button>
          </div>

          <div className="vh3-steps">
            {[
              ["01", "Sense", "웨어러블 신호를 읽고 평소와 다른 변화를 감지합니다.", HeartPulse],
              ["02", "Capture", "발견된 순간에 사진과 메모로 맥락을 더합니다.", Activity],
              [
                "03",
                "Reconstruct",
                "신호와 맥락을 연결해 이야기를 재구성합니다.",
                Sparkles,
              ],
              [
                "04",
                "Replay",
                "기록된 순간을 몰입형 경험으로 다시 만납니다.",
                RotateCcw,
              ],
              ...
              return (
                <div
                  className="vh3-step is-static"
                  key={title as string}
                  onMouseMove={moveGlow}
                >
                  <span className="vh3-step-no">{no as string}</span>
                  <span className="vh3-step-icon">
                    <IconComp />
                  </span>
        ...
        <section className="vh3-dark-band" data-reveal>
          <div className="shell vh3-story-band">
            <div className="vh3-dark-copy">
              <span className="vh3-section-label light"><b>04</b> YOUR STORY, RECONSTRUCTED</span>
              <h2>
                당신이 놓친
                <br />
                소중한 순간을 복원합니다.
              ...
              <p>
                현재 데모에서는 감지된 이벤트의 신호와 맥락, 사진·영상 데이터를
                연결해 그 순간의 이야기를 다시 구성합니다.
              </p>
              <button onClick={() => navigate("/capture")}>
                상황 재구성 보기 <ArrowRight size={16} />
              </button>
            </div>

            <button
              className="vh3-replay-preview"
            ...
            >
              ...
              <div className="vh3-replay-copy">
                ...
                <div className="vh3-replay-stats">
                  <span>
                    심박수 <b>72 bpm</b>
                  </span>
                  <span>
        ...
        <section className="vh3-insight shell" data-reveal>
          <div className="vh3-insight-copy">
            <span className="vh3-section-label"><b>05</b> YOUR MOMENT INSIGHT</span>
            <h2>
              더 깊이 이해하고,
              <br />
              다시 경험합니다.
            ...
            <p>
              VIVIA는 이벤트마다 신호 변화와 맥락을 요약해, 왜 그 순간이
              눈에 띄었는지 확인할 수 있도록 돕습니다.
            </p>
          </div>

          <div className="vh3-insight-grid">
            <article className="vh3-interactive-surface" onMouseMove={moveGlow}>
              <span>신호 변화</span>
              <strong>+18%</strong>
              <small>개인 baseline 대비</small>
              <div className="mini-line aqua-line" />
            </article>
            ...
            <article className="vh3-interactive-surface" onMouseMove={moveGlow}>
              ...
              <small>시간 · 위치 · 활동 · 기록</small>
              <div className="mini-line lav-line" />
            </article>

            <article
              className="insight-accent vh3-interactive-surface"
              onMouseMove={moveGlow}
            >
              <span>Replay Ready</span>
              <h3>
              ...
              <span className="insight-status">RECONSTRUCTED</span>
            </article>
          </div>
        </section>
        ...
        <section className="vh3-final-band" data-reveal>
          <div className="shell">
            <span className="vh3-section-label light centered"><b>06</b> VIVIA FOR LIFE</span>
            <h2>
              VIVIA와 함께,
              <br />
              당신의 이야기를 더 가치 있게.
